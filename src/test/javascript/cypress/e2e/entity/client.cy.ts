...
describe('Client e2e test', () => {
  ...
  const clientSample = { firstName: 'Kaia', lastName: 'Mohr' };
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      cy.get(`[data-cy="firstName"]`).type('Otilia').should('have.value', 'Otilia');
      ...
      cy.get(`[data-cy="address"]`).type('Courts Factors calculating').should('have.value', 'Courts Factors calculating');

      cy.get(`[data-cy="phone"]`).type('270.677.1059 x3492').should('have.value', '270.677.1059 x3492');
